...
STRUCTURE_COLORS: Dict[str, Tuple[int, int, int]] = {
    ...
    "internal_carotid_artery": (255, 0, 0),
    "internal_carotid_artery_left": (255, 0, 0),
    "internal_carotid_artery_right": (255, 0, 0),
    "ica": (255, 0, 0),
    "ica_left": (255, 0, 0),
    "ica_right": (255, 0, 0),
...
NIFTI_STRUCTURE_COLORS_RGBA: Dict[str, Tuple[int, int, int, int]] = {
    ...
    "internal_carotid_artery_left": (255, 0, 0, 150),
    "internal_carotid_artery_right": (255, 0, 0, 150),
